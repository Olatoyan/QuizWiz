...
function Signup() {
  ...
  return (
    <section className="bg-bgColor">
      <Header />
      <div className="min-h-screen grid grid-cols-2  justify-center py-12  px-32 items-center">
        <div className="w-[60rem]">
          <img src="Sign up-amico.svg" alt="Tablet signup" />
        </div>

        <div className="mt-8 sm:mx-auto sm:w-full ">
          <h2 className="text-center text-[3.5rem] font-bold">
            Ready to Learn?
          </h2>
          ...
          <div className="bg-white p-16 shadow  ">
